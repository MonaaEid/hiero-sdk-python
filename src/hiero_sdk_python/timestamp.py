"""Timestamp class for representing moments in time with nanosecond precision."""
import random
import time
...
class Timestamp:
    ...
    def __repr__(self) -> str:
        """Get a detailed string representation of the `Timestamp` for debugging.

        Returns:
            str: The representation in the format `Timestamp(seconds=..., nanos=...)`.

        """
        return f"Timestamp(seconds={self.seconds!r}, nanos={self.nanos!r})"
